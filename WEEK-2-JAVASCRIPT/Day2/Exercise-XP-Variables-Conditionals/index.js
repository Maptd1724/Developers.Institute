...
//3. If x equals 5 and y equals 2, the program should display:
...
if (x > y) {
         console.log("the x is the biggest number")
} else {
         console.log("the y is the biggest number")
}
...
//3. If it is, display: “x is an even number’. Where x is the actual number of the user.
//4. If it isn’t, display “x is not an even number’. Where x is the actual number of the user
...
if (users.length == 0){ //if users array is empty / = no one online
    ...
    console.log(users[0] + " is online"); //tried with [1] as you said still undefined
}else{
    console.log("I'm stuck. SOS")
}